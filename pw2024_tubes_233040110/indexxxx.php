...
<div class="containerconcard">
  ...
  <img src="./assets/lenovo.jpg" class="card-img-top" alt="">
  <div class="card-body">
    <h5 class="card-title">MERK</h5>
    <p class="card-text">Lorem, ipsum dolor.</p>
    <a href="#" class="btn btn-primary">Order</a>
  ...
  <img src="./assets/tuf.jpg" class="card-img-top" alt="">
  <div class="card-body">
    <h5 class="card-title">MERK</h5>
    <p class="card-text">Lorem, ipsum dolor.</p>
    <a href="#" class="btn btn-primary">Order</a>
  ...
  <img src="./assets/icore.jpg" class="card-img-top" alt="">
  <div class="card-body">
    <h5 class="card-title">MERK</h5>
    <p class="card-text">Lorem, ipsum dolor.</p>
